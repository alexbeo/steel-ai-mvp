...
Код, комментарии, docstrings, логи и UI написаны на смеси русского и английского — русский для объяснений/бизнес-терминов, английский для технических идентификаторов. Сохраняйте этот стиль. Пользовательские сообщения (UI, checkpoint-вопросы, HTML-отчёты) — **русский**.
